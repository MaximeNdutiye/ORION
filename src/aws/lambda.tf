...
Explore
 @MaximeNdutiye Sign out
1
0 0 MaximeNdutiye/ORION Private
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
ORION/src/aws/lambda.tf
fdf59b5  18 minutes ago
@MaximeNdutiye MaximeNdutiye make master great again
      
116 lines (103 sloc)  2.77 KB
provider "aws" {
  region = "${var.aws_region}"
}
